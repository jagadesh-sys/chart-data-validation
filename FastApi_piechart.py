...
def process_image(image: bytes= File(...), chartType: str = Form(...)):
    ...
    colour_file_path = os.path.join(os_path, "python-project-color-detection\colors.csv")
    csv = pd.read_csv(colour_file_path,names=index, header=None)
